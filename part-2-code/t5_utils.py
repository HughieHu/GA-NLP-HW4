...
def initialize_model(args):
    ...
    if args.finetune:
        ...
        # Initialize from scratch with same config
        print(f"Initializing T5 model from scratch with config from: {model_name}")
...
def load_model_from_checkpoint(args, best):
    ...
    checkpoint_path = os.path.join(
        args.checkpoint_dir, 
        'best_model.pt' if best else 'last_model.pt'
    )
